...
static char* FormatExprArray[] = {
            ...
            "^[0-9]+_mesh_(fbx|obj)_(high|low)_\\w+\\.(fbx|obj)",
            "^[0-9]+_mesh_(fbx|glm)_(high|low)_\\w+\\.(fbx|glmj)",
            "^[0-9]+_mesh_(fbx|glm)_(low)_\\w+\\.(fbx|glmj)",
            "^[0-9]+_mesh_(fbx|glm)_(high)_\\w+\\.(fbx|glmj)",
            "^[0-9]+_mesh_(fbx|glm)_(high|low)_\\w+\\.(fbx|glmj)",
            "^[0-9]+_mesh_(fbx|glm|obj)_(high|low)_\\w+\\.(fbx|glm|objj)",
            "^[0-9]+_mesh_(fbx|glm|obj)_(low)_\\w+\\.(fbx|glm|objj)",
            "^[0-9]+_mesh_(fbx|glm|obj)_(high)_\\w+\\.(fbx|glm|objj)",
            "^[0-9]+_mesh_(fbx|glm|obj)_(high|low)_\\w+\\.(fbx|glm|objj)"
};
